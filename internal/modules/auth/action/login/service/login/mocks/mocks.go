...
// Source: tennisly.com/mvp/internal/modules/auth/action/login/service/login (interfaces: PasswordHasher,TokenService,RefreshTokenRepository,UserRepository)
//
...
func (m *MockUserRepository) Get(ctx context.Context, arg1 *user.User) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) Get(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockUserRepository)(nil).Get), ctx, arg1)
}
